...
/**
 * Class for Assign Line Materials Assign menu.
 * 
 * @author Murat
 * 
 */
public class ALineMaterial1 extends JDialog implements ActionListener,
		ItemListener {
	 ...
	 */
	public ALineMaterial1(SolidMAT owner) {
	...
	private boolean setIdsFromText() {
		...
		try {
			...
			for (int i = 0; i < comp.length; i++) {
				...
				// check if negative
				if (val < 0) {
					JOptionPane.showMessageDialog(ALineMaterial1.this,
