...
/**
 * Class for Assign Area Temperature Loads Assign menu.
 * 
 * @author Murat
 * 
 */
public class AAreaTempLoad1 extends JDialog implements ActionListener,
		ItemListener {
	 ...
	 */
	public AAreaTempLoad1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Assign Area Temperature Loads", true);
		owner_ = owner;
	...
	private boolean checkSelection() {
		...
		if (radiobutton3_.isSelected() || radiobutton4_.isSelected()) {
			if (list1_.isSelectionEmpty()) {
				...
				// display message
				JOptionPane.showMessageDialog(AAreaTempLoad1.this,
