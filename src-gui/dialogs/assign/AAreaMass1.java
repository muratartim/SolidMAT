...
/**
 * Class for Assign Area Masses Assign menu.
 * 
 * @author Murat
 * 
 */
public class AAreaMass1 extends JDialog implements ActionListener, ItemListener {
	 ...
	 */
	public AAreaMass1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Assign Area Masses", true);
		owner_ = owner;
		...
		if (m != null) {
			...
			for (int i = 0; i < elementIds_.size(); i++) {
				...
				if (dofv.contains(comp) == false) {
					...
					// display message
					JOptionPane.showMessageDialog(AAreaMass1.this,
