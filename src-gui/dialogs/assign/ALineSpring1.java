...
/**
 * Class for Assign Line Springs Assign menu.
 * 
 * @author Murat
 * 
 */
public class ALineSpring1 extends JDialog implements ActionListener,
		ItemListener {
	 ...
	 */
	public ALineSpring1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Assign Line Springs", true);
		owner_ = owner;
		...
		if (s != null) {
			...
			for (int i = 0; i < elementIds_.size(); i++) {
				...
				if (dofv.contains(comp) == false) {
					...
					// display message
					JOptionPane.showMessageDialog(ALineSpring1.this,
