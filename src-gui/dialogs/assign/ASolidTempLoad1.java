...
/**
 * Class for Assign Solid Temperature Loads Assign menu.
 * 
 * @author Murat
 * 
 */
public class ASolidTempLoad1 extends JDialog implements ActionListener,
		ItemListener {
	 ...
	 */
	public ASolidTempLoad1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Assign Solid Temperature Loads", true);
		owner_ = owner;
	...
	private boolean checkSelection() {
		...
		if (radiobutton3_.isSelected() || radiobutton4_.isSelected()) {
			if (list1_.isSelectionEmpty()) {
				...
				// display message
				JOptionPane.showMessageDialog(ASolidTempLoad1.this,
