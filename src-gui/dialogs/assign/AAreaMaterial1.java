...
/**
 * Class for Assign Area Materials Assign menu.
 * 
 * @author Murat
 * 
 */
public class AAreaMaterial1 extends JDialog implements ActionListener,
		ItemListener {
	 ...
	 */
	public AAreaMaterial1(SolidMAT owner) {
	...
	private boolean setIdsFromText() {
		...
		try {
			...
			for (int i = 0; i < comp.length; i++) {
				...
				// check if negative
				if (val < 0) {
					JOptionPane.showMessageDialog(AAreaMaterial1.this,
