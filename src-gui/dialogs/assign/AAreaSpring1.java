...
/**
 * Class for Assign Area Springs Assign menu.
 * 
 * @author Murat
 * 
 */
public class AAreaSpring1 extends JDialog implements ActionListener,
		ItemListener {
	 ...
	 */
	public AAreaSpring1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Assign Area Springs", true);
		owner_ = owner;
		...
		if (s != null) {
			...
			for (int i = 0; i < elementIds_.size(); i++) {
				...
				if (dofv.contains(comp) == false) {
					...
					// display message
					JOptionPane.showMessageDialog(AAreaSpring1.this,
