...
/**
 * Class for Assign Line Masses Assign menu.
 * 
 * @author Murat
 * 
 */
public class ALineMass1 extends JDialog implements ActionListener, ItemListener {
	 ...
	 */
	public ALineMass1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Assign Line Masses", true);
		owner_ = owner;
		...
		if (m != null) {
			...
			for (int i = 0; i < elementIds_.size(); i++) {
				...
				if (dofv.contains(comp) == false) {
					...
					// display message
					JOptionPane.showMessageDialog(ALineMass1.this,
