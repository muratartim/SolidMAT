 ...
 * 
 */
public class AAreaSection1 extends JDialog implements ActionListener,
		ItemListener {
	 ...
	 */
	public AAreaSection1(SolidMAT owner) {
	...
	private boolean setIdsFromText() {
		...
		try {
			...
			for (int i = 0; i < comp.length; i++) {
				...
				// check if negative
				if (val < 0) {
					JOptionPane.showMessageDialog(AAreaSection1.this,
