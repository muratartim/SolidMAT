...
/**
 * Class for Nodal Mass Library menu.
 * 
 * @author Murat
 * 
 */
public class NodalMass1 extends JDialog implements ActionListener {
	...
	protected Vector<NodalMass> temporary_ = new Vector<NodalMass>();
	 ...
	 */
	public NodalMass1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Nodal Mass Library", true);
		owner_ = owner;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			NodalMass2 dialog = new NodalMass2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				NodalMass2 dialog = new NodalMass2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setNodalMass(temporary_);
