...
/**
 * Class for Initial Displacements Library menu.
 * 
 * @author Murat
 * 
 */
public class InitialDisp1 extends JDialog implements ActionListener {
	...
	protected Vector<InitialDisp> temporary_ = new Vector<InitialDisp>();
	 ...
	 */
	public InitialDisp1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Initial Displacements Library", true);
		owner_ = owner;
		...
		// build sub-panels
		JPanel panel3 = Commons.getPanel("Displacements", Commons.gridbag_);
	...
	private void initialize() {
		...
		Vector<InitialDisp> object = owner_.inputData_.getInitialDisp();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			InitialDisp2 dialog = new InitialDisp2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				InitialDisp2 dialog = new InitialDisp2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setInitialDisp(temporary_);
