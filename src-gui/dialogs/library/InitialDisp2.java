...
/**
 * Class for Add/Modify Initial Displacements menu.
 * 
 * @author Murat
 * 
 */
public class InitialDisp2 extends JDialog implements ActionListener,
	 ...
	 *            mother dialog.
	 */
	public InitialDisp2(InitialDisp1 owner, boolean add) {
		...
		label4_ = new JLabel("Translation X :");
		label5_ = new JLabel("Translation Y :");
		label6_ = new JLabel("Translation Z :");
		label7_ = new JLabel("Rotation about X :");
		label8_ = new JLabel("Rotation about Y :");
		label9_ = new JLabel("Rotation about Z :");
	...
	private void initialize() {
		...
		InitialDisp selected = owner_.temporary_.get(index);
	...
	private void actionOkAddModify() {
		...
		// create object
		InitialDisp object = new InitialDisp(name, bCase, new DVec(values));
	...
	public void itemStateChanged(ItemEvent event) {
		...
		if (event.getSource().equals(combobox2_)) {
			...
			if (index == NodalMechLoad.global_) {
				label4_.setText("Translation X :");
				label5_.setText("Translation Y :");
				label6_.setText("Translation Z :");
				label7_.setText("Rotation about X :");
				label8_.setText("Rotation about Y :");
				label9_.setText("Rotation about Z :");
			}

			// for the "Local" option
			else if (index == NodalMechLoad.local_) {
				label4_.setText("Translation 1 :");
				label5_.setText("Translation 2 :");
				label6_.setText("Translation 3 :");
				label7_.setText("Rotation about 1 :");
				label8_.setText("Rotation about 2 :");
				label9_.setText("Rotation about 3 :");
			}
		}
	}
	...
	private boolean checkText(JTextField textfield, int messageType) {
		...
		if (messageType == 0) {
			...
			if (text.equals("")) {
				...
				// display message
				JOptionPane.showMessageDialog(InitialDisp2.this,
