...
/**
 * Class for Material Library menu.
 * 
 * @author Murat
 * 
 */
public class Material1 extends JDialog implements ActionListener {
	...
	protected Vector<Material> temporary_ = new Vector<Material>();
	 ...
	 */
	public Material1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Material Library", true);
		owner_ = owner;
		...
		// build sub-panels
		JPanel panel3 = Commons.getPanel("Materials", Commons.gridbag_);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			Material2 dialog = new Material2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				Material2 dialog = new Material2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setMaterial(temporary_);
