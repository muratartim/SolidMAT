...
/**
 * Class for Element Spring Library menu.
 * 
 * @author Murat
 * 
 */
public class ElementSpring1 extends JDialog implements ActionListener {
	...
	protected Vector<ElementSpring> temporary_ = new Vector<ElementSpring>();
	 ...
	 */
	public ElementSpring1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Element Spring Library", true);
		owner_ = owner;
		...
		// build sub-panels
		JPanel panel3 = Commons.getPanel("Springs", Commons.gridbag_);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			ElementSpring2 dialog = new ElementSpring2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				ElementSpring2 dialog = new ElementSpring2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setElementSpring(temporary_);
