...
/**
 * Class for Add/Modify Initial Velocities menu.
 * 
 * @author Murat
 * 
 */
public class InitialVelo2 extends JDialog implements ActionListener,
	 ...
	 *            mother dialog.
	 */
	public InitialVelo2(InitialVelo1 owner, boolean add) {
		...
		JPanel panel4 = Commons.getPanel("Velocities", Commons.gridbag_);
	...
	private void initialize() {
		...
		InitialVelo selected = owner_.temporary_.get(index);
	...
	private void actionOkAddModify() {
		...
		// create object
		InitialVelo object = new InitialVelo(name, bCase, new DVec(values));
	...
	private boolean checkText(JTextField textfield, int messageType) {
		...
		if (messageType == 0) {
			...
			if (text.equals("")) {
				...
				// display message
				JOptionPane.showMessageDialog(InitialVelo2.this,
