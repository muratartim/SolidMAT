...
/**
 * Class for Prescribed Displacement Library menu.
 * 
 * @author Murat
 * 
 */
public class DispLoad1 extends JDialog implements ActionListener {
	...
	protected Vector<DispLoad> temporary_ = new Vector<DispLoad>();
	 ...
	 */
	public DispLoad1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Nodal Displacements Library", true);
		owner_ = owner;
	...
	private void initialize() {
		...
		Vector<DispLoad> object = owner_.inputData_.getDispLoad();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			DispLoad2 dialog = new DispLoad2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				DispLoad2 dialog = new DispLoad2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setDispLoad(temporary_);
