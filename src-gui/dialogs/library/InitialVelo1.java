...
/**
 * Class for Initial Velocities Library menu.
 * 
 * @author Murat
 * 
 */
public class InitialVelo1 extends JDialog implements ActionListener {
	...
	protected Vector<InitialVelo> temporary_ = new Vector<InitialVelo>();
	 ...
	 */
	public InitialVelo1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Initial Velocities Library", true);
		owner_ = owner;
		...
		// build sub-panels
		JPanel panel3 = Commons.getPanel("Velocities", Commons.gridbag_);
	...
	private void initialize() {
		...
		Vector<InitialVelo> object = owner_.inputData_.getInitialVelo();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			InitialVelo2 dialog = new InitialVelo2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				InitialVelo2 dialog = new InitialVelo2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setInitialVelo(temporary_);
