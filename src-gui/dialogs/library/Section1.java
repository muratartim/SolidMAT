...
/**
 * Class for Section Library menu.
 * 
 * @author Murat
 * 
 */
public class Section1 extends JDialog implements ActionListener {
	...
	protected Vector<Section> temporary_ = new Vector<Section>();
	 ...
	 */
	public Section1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Section Library", true);
		owner_ = owner;
		...
		// build sub-panels
		JPanel panel3 = Commons.getPanel("Sections", Commons.gridbag_);

		// build list model and list, set single selection mode,
		// visible row number, fixed width, fixed height, set font
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			Section2 dialog = new Section2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				Section2 dialog = new Section2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setSection(temporary_);
