...
/**
 * Class for Element Temperature Load Library menu.
 * 
 * @author Murat
 * 
 */
public class ElementTemp1 extends JDialog implements ActionListener {
	...
	protected Vector<ElementTemp> temporary_ = new Vector<ElementTemp>();
	 ...
	 */
	public ElementTemp1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Temperature Load Library", true);
		owner_ = owner;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			ElementTemp2 dialog = new ElementTemp2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				ElementTemp2 dialog = new ElementTemp2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setElementTemp(temporary_);
