...
/**
 * Class for Add/Modify Element Springs menu.
 * 
 * @author Murat
 * 
 */
public class ElementSpring2 extends JDialog implements ActionListener,
	...
	protected ElementSpring1 owner_;
	 ...
	 *            mother dialog.
	 */
	public ElementSpring2(ElementSpring1 owner, boolean add) {
		...
		JLabel label4 = new JLabel("Stiffness :");
	...
	private void initialize() {
		...
		ElementSpring selected = owner_.temporary_.get(index);
	...
	private void actionOkAddModify() {
		...
		// create object
		ElementSpring object = new ElementSpring(name, comp, coord, value);
	...
	public void itemStateChanged(ItemEvent event) {
		...
		if (event.getSource().equals(combobox1_)) {
			...
			if (index == ElementSpring.global_) {
			...
			else if (index == ElementSpring.local_) {
	...
	private boolean checkText(JTextField textfield, int messageType) {
		...
		if (messageType == 0) {
			...
			if (text.equals("")) {
				...
				// display message
				JOptionPane.showMessageDialog(ElementSpring2.this,
