...
/**
 * Class for Local Axis Library menu.
 * 
 * @author Murat
 * 
 */
public class LocalAxis1 extends JDialog implements ActionListener {
	...
	protected Vector<LocalAxis> temporary_ = new Vector<LocalAxis>();
	 ...
	 */
	public LocalAxis1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Local Axes Library", true);
		owner_ = owner;
		...
		// build sub-panels
		JPanel panel3 = Commons.getPanel("Local Axes", Commons.gridbag_);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			LocalAxis2 dialog = new LocalAxis2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				LocalAxis2 dialog = new LocalAxis2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setLocalAxis(temporary_);
