...
/**
 * Class for Element Mass Library menu.
 * 
 * @author Murat
 * 
 */
public class ElementMass1 extends JDialog implements ActionListener {
	...
	protected Vector<ElementMass> temporary_ = new Vector<ElementMass>();
	 ...
	 */
	public ElementMass1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Element Mass Library", true);
		owner_ = owner;
		...
		// build sub-panels
		JPanel panel3 = Commons.getPanel("Masses", Commons.gridbag_);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			ElementMass2 dialog = new ElementMass2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				ElementMass2 dialog = new ElementMass2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setElementMass(temporary_);
