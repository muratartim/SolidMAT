...
/**
 * Class for Element Library menu.
 * 
 * @author Murat
 * 
 */
public class ElementLib1 extends JDialog implements ActionListener {
	...
	protected Vector<ElementLibrary> temporary_ = new Vector<ElementLibrary>();
	 ...
	 */
	public ElementLib1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Element Library", true);
		owner_ = owner;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			ElementLib2 dialog = new ElementLib2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				ElementLib2 dialog = new ElementLib2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setElementLibrary(temporary_);
