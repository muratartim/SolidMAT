...
/**
 * Class for Nodal Spring Library menu.
 * 
 * @author Murat
 * 
 */
public class NodalSpring1 extends JDialog implements ActionListener {
	...
	protected Vector<NodalSpring> temporary_ = new Vector<NodalSpring>();
	 ...
	 */
	public NodalSpring1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Nodal Spring Library", true);
		owner_ = owner;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			NodalSpring2 dialog = new NodalSpring2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				NodalSpring2 dialog = new NodalSpring2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setNodalSpring(temporary_);
