...
/**
 * Class for Element Mechanical Load Library menu.
 * 
 * @author Murat
 * 
 */
public class ElementMechLoad1 extends JDialog implements ActionListener {
	...
	protected Vector<ElementMechLoad> temporary_ = new Vector<ElementMechLoad>();
	 ...
	 */
	public ElementMechLoad1(SolidMAT owner) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			ElementMechLoad2 dialog = new ElementMechLoad2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				ElementMechLoad2 dialog = new ElementMechLoad2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setElementMechLoad(temporary_);
