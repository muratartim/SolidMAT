...
/**
 * Class for Analysis Case Library menu.
 * 
 * @author Murat
 * 
 */
public class AnalysisCase1 extends JDialog implements ActionListener {
	...
	protected Vector<Analysis> temporary_ = new Vector<Analysis>();
	 ...
	 */
	public AnalysisCase1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Analysis Cases Library", true);
		owner_ = owner;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			AnalysisCase2 dialog = new AnalysisCase2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				AnalysisCase2 dialog = new AnalysisCase2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setAnalysis(temporary_);
