...
/**
 * Class for Linear Static Analysis Progress monitoring.
 * 
 * @author Murat
 * 
 */
public class LSProgress1 extends JDialog implements ActionListener {
	...
	private LinearStatic analysis_;
	 ...
	 */
	public LSProgress1(RunAnalysis1 owner, Analysis analysis) {

		// build dialog, determine owner dialog, give caption, make it modal
		super(owner, "Linear Static Analysis", true);
		analysis_ = (LinearStatic) analysis;
		owner_ = owner;
		...
		JLabel label4 = new JLabel("Number of iterations :");
		JLabel label5 = new JLabel("Final residual :");
		label6_ = new JLabel(" ");
		...
		timer1_ = new Timer(ONE_SECOND, new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				...
				if (analysis_.getNumberOfIterations() != null) {
					textfield4_.setText(analysis_.getNumberOfIterations()
							.toString());
