...
/**
 * Class for Modal Analysis Progress monitoring.
 * 
 * @author Murat
 * 
 */
public class MProgress1 extends JDialog implements ActionListener {
	 ...
	 */
	public MProgress1(RunAnalysis1 owner, Analysis analysis) {

		// build dialog, determine owner dialog, give caption, make it modal
		super(owner, "Modal Analysis", true);
		analysis_ = (Modal) analysis;
		owner_ = owner;
		...
		JLabel label5 = new JLabel("Minimum natural frequency :");
		label6_ = new JLabel(" ");
			...
			public void actionPerformed(ActionEvent evt) {
				...
				if (analysis_.isKilled() || analysis_.isCompleted()) {
					...
					if (analysis_.isCompleted()) {
						...
						// set minimum natural frequency
						textfield5_.setText(owner_.owner_.formatter_
								.format(analysis_.getNaturalFrequencies()[0]));
					}
				}
			}
		});
