...
/**
 * Class for Mirror Node Options Model menu.
 * 
 * @author Murat
 * 
 */
public class MirrorNode2 extends JDialog implements ActionListener {

	private static final long serialVersionUID = 1L;

	private JCheckBox checkbox1_, checkbox2_, checkbox3_, checkbox4_,
			checkbox5_, checkbox6_, checkbox7_, checkbox8_;

	/** Mother dialog of this dialog. */
	private MirrorNode1 owner_;
	 ...
	 */
	public MirrorNode2(MirrorNode1 owner) {

		// build dialog, determine owner dialog, give caption, make it modal
		super(owner, "Mirror Options", true);
		owner_ = owner;
		...
		// build checkboxes
		checkbox1_ = new JCheckBox("Constraints");
		checkbox2_ = new JCheckBox("Local Axes");
		checkbox3_ = new JCheckBox("Mechanical loads");
		checkbox4_ = new JCheckBox("Displacement loads");
		checkbox5_ = new JCheckBox("Initial displacements");
		checkbox6_ = new JCheckBox("Initial velocities");
		checkbox7_ = new JCheckBox("Springs");
		checkbox8_ = new JCheckBox("Masses");
		...
		Commons.addComponent(panel3, checkbox8_, 3, 1, 1, 1);
	...
	private void initialize() {
		...
		checkbox8_.setSelected(owner_.options_[7]);
	}
	...
	private void actionOk() {
		...
		owner_.options_[7] = checkbox8_.isSelected();
