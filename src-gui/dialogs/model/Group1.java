...
/**
 * Class for Groups Model menu.
 * 
 * @author Murat
 * 
 */
public class Group1 extends JDialog implements ActionListener {
	...
	protected Vector<Group> temporary_ = new Vector<Group>();
	 ...
	 */
	public Group1(SolidMAT owner) {

		// build dialog, determine owner frame, give caption, make it modal
		super(owner.viewer_, "Define Groups", true);
		owner_ = owner;
		...
		// build sub-panels
		JPanel panel3 = Commons.getPanel("Groups", Commons.gridbag_);
	...
	private void initialize() {
		...
		Vector<Group> object = owner_.inputData_.getGroup();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Add") {
			...
			Group2 dialog = new Group2(this, true);
		...
		// modify button clicked
			...
			if (list1_.isSelectionEmpty() == false) {
				...
				// build child dialog and set visible
				Group2 dialog = new Group2(this, false);
				dialog.setVisible(true);
			}
		}
	...
	private void actionOk() {
		...
		owner_.inputData_.setGroup(temporary_);
