 ...
 * 
 */
public class DisplayVLineResult2 extends JDialog implements ActionListener,
		ItemListener {
	...
	private DisplayVLineResult1 owner_;
	 ...
	 */
	public DisplayVLineResult2(DisplayVLineResult1 owner) {
