...
/**
 * Class for Display Area Results menu.
 * 
 * @author Murat
 * 
 */
public class DisplayVAreaResult1 extends JDialog implements ActionListener,
		ItemListener {
	 ...
	 */
	public DisplayVAreaResult1(SolidMAT owner) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		// options button clicked
			...
			DisplayVAreaResult2 dialog = new DisplayVAreaResult2(this);
	...
	private void actionOk() {
		...
		if (checkText()) {
			...
			if (combobox1_.getSelectedIndex() == 0) {
				...
				// set option
				option = PostVisualizer.elementDisp2D_;
			...
			// elastic strains
				...
				// set result option
				option = PostVisualizer.elasticStrains2D_;
				...
				if (index == 0) {
					...
					option = PostVisualizer.principalStrains2D_;
			...
			// stresses
				...
				// set result option
				option = PostVisualizer.stresses2D_;
				...
				if (index == 0) {
					...
					option = PostVisualizer.principalStresses2D_;
					comp[0] = Element.minPrincipal_;
				} else if (index == 9) {
					option = PostVisualizer.principalStresses2D_;
					comp[0] = Element.midPrincipal_;
					...
					option = PostVisualizer.misesStress2D_;
			}
			...
			// internal forces
				...
				// set result option
				option = PostVisualizer.internalForces2D_;

				// set component
				int index = combobox2_.getSelectedIndex();
				if (index == 0)
					comp[0] = Element2D.P11_;
				else if (index == 1)
					comp[0] = Element2D.N22_;
				else if (index == 2)
					comp[0] = Element2D.Q12_;
				else if (index == 3)
					comp[0] = Element2D.F13_;
				else if (index == 4)
					comp[0] = Element2D.H23_;
				else if (index == 5)
					comp[0] = Element2D.T12_;
				else if (index == 6)
					comp[0] = Element2D.M11_;
				else if (index == 7)
					comp[0] = Element2D.K22_;
			}
	...
	private String[] getArray() {
		...
		// internal forces
			...
			array = new String[8];
			array[0] = "Normal force 11";
			array[1] = "Normal force 22";
			array[2] = "Shear force 12";
			array[3] = "Shear force 13";
			array[4] = "Shear force 23";
			array[5] = "Twisting moment 12";
			array[6] = "Bending moment 11";
			array[7] = "Bending moment 22";
		}
