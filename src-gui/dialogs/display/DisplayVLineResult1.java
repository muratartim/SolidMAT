...
/**
 * Class for Display Line Results menu.
 * 
 * @author Murat
 * 
 */
public class DisplayVLineResult1 extends JDialog implements ActionListener,
		ItemListener {
	 ...
	 */
	public DisplayVLineResult1(SolidMAT owner) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		// options button clicked
			...
			DisplayVLineResult2 dialog = new DisplayVLineResult2(this);
	...
	private void actionOk() {
		...
		if (checkText()) {
			...
			if (combobox1_.getSelectedIndex() == 0) {
				...
				// set option
				option = PostVisualizer.elementDisp1D_;
			...
			// elastic strains
				...
				// set result option
				option = PostVisualizer.elasticStrains1D_;
				...
				if (index == 0) {
					...
					option = PostVisualizer.principalStrains1D_;
			...
			// stresses
				...
				// set result option
				option = PostVisualizer.stresses1D_;
				...
				if (index == 0) {
					...
					option = PostVisualizer.principalStresses1D_;
					comp[0] = Element.minPrincipal_;
				} else if (index == 9) {
					option = PostVisualizer.principalStresses1D_;
					comp[0] = Element.midPrincipal_;
					...
					option = PostVisualizer.misesStress1D_;
			}
			...
			// internal forces
				...
				// set result option
				option = PostVisualizer.internalForces1D_;

				// set component
				int index = combobox2_.getSelectedIndex();
				if (index == 0)
					comp[0] = Element1D.N1_;
				else if (index == 1)
					comp[0] = Element1D.V2_;
				else if (index == 2)
					comp[0] = Element1D.V3_;
				else if (index == 3)
					comp[0] = Element1D.T1_;
				else if (index == 4)
					comp[0] = Element1D.M2_;
				else if (index == 5)
					comp[0] = Element1D.M3_;
			}
	...
	private String[] getArray() {
		...
		// internal forces
			...
			array = new String[6];
			array[0] = "Axial force";
			array[1] = "Shear force 2";
			array[2] = "Shear force 3";
			array[3] = "Torsion";
			array[4] = "Bending moment 2";
			array[5] = "Bending moment 3";
		}
