...
/**
 * Class for writing stress information to output file.
 * 
 * @author Murat
 * 
 */
public class StressInfo extends Writer {
	...
	/**
	 * Creates StressInfo object.
	 * 
	 * @param stations
	 *            The number of output stations.
	 */
	public StressInfo(int stations) {
		stations_ = stations;
	}

	/**
	 * Writes stress information to output file.
	 * 
	 * @param structure
	...
	private void writeTable1() {
		...
		try {
			...
			bwriter_.write(header("Stresses (One dimensional elements), 1"));
			...
			// write headers
			String[] table = { "Element", "Station", "s11", "s22", "s33" };
			...
			for (int i = 0; i < element1D_.size(); i++) {
				...
				for (int j = 0; j < stations_; j++) {
					...
					// write components
					table[2] = formatter(stress.get(0, 0));
					table[3] = formatter(stress.get(1, 1));
					table[4] = formatter(stress.get(2, 2));
	...
	private void writeTable2() {
		...
		try {
			...
			// write header for first part of table
			bwriter_.write(header("Stresses (One dimensional elements), 2"));
			...
			// write headers
			String[] table = { "Element", "Station", "s12", "s13", "s23" };
			bwriter_.write(table(table));
			...
			for (int i = 0; i < element1D_.size(); i++) {
				...
				for (int j = 0; j < stations_; j++) {
					...
					// write components
					table[2] = formatter(stress.get(0, 1));
					table[3] = formatter(stress.get(0, 2));
					table[4] = formatter(stress.get(1, 2));
	...
	private void writeTable3() {
		...
		try {
			...
			// write header for first part of table
			bwriter_.write(header("Stresses (Two dimensional elements), 1"));
			...
			// write headers
			String[] table = { "Element", "Corner", "s11", "s22", "s33" };
			bwriter_.write(table(table));
	...
	private void writeTable4() {
		...
		try {
			...
			// write header for first part of table
			bwriter_.write(header("Stresses (Two dimensional elements), 2"));
			...
			// write headers
			String[] table = { "Element", "Corner", "s12", "s13", "s23" };
			bwriter_.write(table(table));
	...
	private void writeTable5() {
		...
		try {
			...
			// write header for first part of table
			bwriter_.write(header("Stresses (Three dimensional elements), 1"));
			...
			// write headers
			String[] table = { "Element", "Vertex", "s11", "s22", "s33" };
			bwriter_.write(table(table));
	...
	private void writeTable6() {
		...
		try {
			...
			// write header for first part of table
			bwriter_.write(header("Stresses (Three dimensional elements), 2"));
			...
			// write headers
			String[] table = { "Element", "Vertex", "s12", "s13", "s23" };
			bwriter_.write(table(table));
