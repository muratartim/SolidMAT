...
/**
 * Class for outward twin channel cross section.
 * 
 * @author Murat
 * 
 */
public class OTwinChannelCS extends Section {
	...
	/**
	 * Creates outward twin channel cross section.
	 * 
	 * @param name
	 *            The name of section.
	 * @param h
	 ...
	 */
	public OTwinChannelCS(String name, double h, double b, double b1, double t) {
	...
	public double getInertiaX2(int i) {
		return t_
				/ 6.0
				* (b_ * t_ * t_ + 6.0 * b1_ * h_ * h_ + 12.0 * b1_ * b1_ * h_ + 8.0
						* b1_ * b1_ * b1_);
	}
	...
	public double[][] getOutline() {
		...
		outline[0][0] = -b_ / 2.0;
		outline[0][1] = -(h_ + 2.0 * b1_) / 2.0;
		outline[1][0] = b_ / 2.0;
		outline[1][1] = -(h_ + 2.0 * b1_) / 2.0;
		outline[2][0] = b_ / 2.0;
		outline[2][1] = (h_ + 2.0 * b1_) / 2.0;
		outline[3][0] = -b_ / 2.0;
		outline[3][1] = (h_ + 2.0 * b1_) / 2.0;
		return outline;
	}
