...
/**
 * Class for thin walled c cross section.
 * 
 * @author Murat
 * 
 */
public class CCS extends Section {
	...
	/**
	 * Creates thin walled c cross section.
	 * 
	 * @param name
	 *            The name of section.
	 * @param h
	 ...
	 */
	public CCS(String name, double h, double b, double b1, double t) {
