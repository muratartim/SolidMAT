...
/**
 * Class for Element16. Properties of element are; Mechanics: Mindlin/Reissner
 * shell, Geometric: Linear, Material: Orthotropic/Isotropic, Interpolation
 * degree: Bilinear, Interpolation family: Lagrange, Number of nodes: 4,
 * Geometry: Quadrilateral, Dofs (per node): ux, uy, uz, rx, ry, rz (global),
 * u1, u2, u3, r1, r2 (local), Mechanical loading: fx, fy, fz, mx, my, mz
 * (global), f1, f2, f3, m1, m2 (local), Temperature loading: yes,
 ...
 * M11, T12. Note: Transverse shear terms are under-integrated against shear
 * locking.
 * 
 * @author Murat
 * 
 */
public class Element16 extends Element2D {
	...
	/**
	 * Creates Element16 element. Nodes should be given in counter-clockwise
	 * order.
	 * 
	 * @param n1
	 ...
	 */
	public Element16(Node n1, Node n2, Node n3, Node n4) {
		nodes_[0] = n1;
		nodes_[1] = n2;
		nodes_[2] = n3;
		nodes_[3] = n4;
