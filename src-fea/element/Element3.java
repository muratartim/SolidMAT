...
/**
 * Class for Element3. Properties of element are; Mechanics: Plane (plane
 ...
 * 
 */
public class Element3 extends Element2D {
	...
	/**
	 * Creates Element3 element. Nodes should be given in counter-clockwise
	 * order.
	 * 
	 * @param n1
	 ...
	 */
	public Element3(Node n1, Node n2, Node n3, Node n4) {
		nodes_[0] = n1;
		nodes_[1] = n2;
		nodes_[2] = n3;
		nodes_[3] = n4;
