...
/**
 * Class for Element9. Properties of element are; Mechanics: Plane (plane
 ...
 * 
 */
public class Element9 extends Element2D {
	...
	/**
	 * Creates Element9 element. Nodes should be given in counter-clockwise
	 * order.
	 * 
	 * @param n1
	 ...
	 */
	public Element9(Node n1, Node n2, Node n3, Node n4, Node n5, Node n6,
			Node n7, Node n8) {
		nodes_[0] = n1;
		nodes_[1] = n2;
		nodes_[2] = n3;
