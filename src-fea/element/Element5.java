...
/**
 * Class for Element5. Properties of element are; Mechanics: Plane (plane
 * stress), Geometric: Linear, Material: Orthotropic/Isotropic, Interpolation
 * degree: Bilinear, Interpolation family: Lagrange, Number of nodes: 3,
 ...
 * yes, Displacements: u1, u2, Strains: e11, e22, e12, e33, Stresses: s11, s22,
 * s12, Internal forces: P11, N22, Q12.
 * 
 * @author Murat
 * 
 */
public class Element5 extends Element2D {
	...
	/**
	 * Creates Element5 element. Nodes should be given in counter-clockwise
	 * order.
	 * 
	 * @param n1
	 ...
	 */
	public Element5(Node n1, Node n2, Node n3) {
		nodes_[0] = n1;
		nodes_[1] = n2;
		nodes_[2] = n3;
	}
