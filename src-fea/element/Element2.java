...
/**
 * Class for Element2. Properties of element are; Mechanics: Truss, Geometric:
 * Linear, Material: Orthotropic/Isotropic, Interpolation degree: Cubic,
 * Interpolation family: Lagrange, Number of nodes: 4, Dofs (per node): ux, uy,
 ...
 * 
 */
public class Element2 extends Element1D {
	 ...
	 */
	public Element2(Node n1, Node n2, Node n3, Node n4) {
