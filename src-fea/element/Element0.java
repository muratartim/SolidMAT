...
/**
 * Class for Element0. Properties of element are; Mechanics: Truss, Geometric:
 * Linear, Material: Orthotropic/Isotropic, Interpolation degree: Linear,
 * Interpolation family: Lagrange, Number of nodes: 2, Dofs (per node): ux, uy,
 ...
 * 
 */
public class Element0 extends Element1D {
	 ...
	 */
	public Element0(Node n1, Node n2) {
		nodes_[0] = n1;
		nodes_[1] = n2;
	}
