...
/**
 * Class for Element22. Properties of element are; Mechanics: Solid, Geometric:
 * Linear, Material: Orthotropic/Isotropic, Interpolation degree: Trilinear,
 * Interpolation family: Lagrange, Number of nodes: 8, Geometry: Hexahedral,
 ...
 * 
 */
public class Element22 extends Element3D {
	...
	/**
	 * Creates Element22 element. Nodes should be given in counter-clockwise
	 ...
	 * @param n3
	 *            The third node of element.
	 * @param n4
	 *            The fourth node of element.
	 * @param n5
	 *            The fifth node of element.
	 * @param n6
	 *            The sixth node of element.
	 * @param n7
	 *            The seventh node of element.
	 * @param n8
	 *            The eighth node of element.
	 */
	public Element22(Node n1, Node n2, Node n3, Node n4, Node n5, Node n6,
			Node n7, Node n8) {
		nodes_[0] = n1;
		nodes_[1] = n2;
		nodes_[2] = n3;
	...
	protected Interpolation3D getInterpolation() {
		...
		int degree = Interpolation3D.trilinear_;
