...
/**
 * Class for Element33. Properties of element are; Mechanics: XZ Planar Truss,
 ...
 * node): ux, uz (global), u1 (local), Mechanical loading: fx, fz (global), f1
 * (local), Temperature loading: yes, Displacements: u1, Strains: e11, e22, e33,
 * Stresses: s11, Internal forces: N1. Note: Element must be used in XZ plane.
 * 
 * @author Murat
 * 
 */
public class Element33 extends Element1D {
	 ...
	 */
	public Element33(Node n1, Node n2, Node n3) {
