...
/**
 * Class for Element17. Properties of element are; Mechanics: Mindlin/Reissner
 ...
 * 
 */
public class Element17 extends Element2D {
	 ...
	 */
	public Element17(Node n1, Node n2, Node n3, Node n4, Node n5, Node n6,
			Node n7, Node n8) {
		nodes_[0] = n1;
		nodes_[1] = n2;
		nodes_[2] = n3;
	...
	private DMat getUncondensedStiffness() {
		...
		for (int i = 0; i < k1.rowCount(); i++) {
			for (int j = 0; j < k1.columnCount(); j++) {
				...
				kLocal.set(i + 24, j + 24, phi * k1.get(i, j));
