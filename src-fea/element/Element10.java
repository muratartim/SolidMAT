...
/**
 * Class for Element10. Properties of element are; Mechanics: Plane (plane
 ...
 * loading: yes, Displacements: u1, u2, Strains: e11, e22, e12, Stresses: s11,
 * s22, s33, s12, Internal forces: P11, N22, Q12.
 * 
 * @author Murat
 * 
 */
public class Element10 extends Element2D {
	...
	/**
	 * Creates Element10 element. Nodes should be given in counter-clockwise
	 * order.
	 * 
	 * @param n1
	 ...
	 */
	public Element10(Node n1, Node n2, Node n3, Node n4, Node n5, Node n6,
